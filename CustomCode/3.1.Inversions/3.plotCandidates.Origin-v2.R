...
# filter 
ICVsFilter = subset(ICVs, chrom == "Herato09")
ICVsFilter = subset(ICVs, chrom == "Hmel211")
chr = "Hmel209"
ICVsFilter = subset(ICVs, SameSpecies == 2 & chrom == chr)
ICVsFilter = subset(ICVsFilter, chrom == chr)
...
subset(ICVsFilter, chrom == "Herato09")
subset(ICVs, chrom == "Herato09" & species == "hera")
